...
$query = db::query("SELECT cid, dateofad, univname, funding, gpa, label, languagescore, subject, noteforchoose, schoolname, subsubject, noteforad FROM `case` WHERE hidden = 0 ORDER BY dateofad DESC", addslashes($_GET['y']));
